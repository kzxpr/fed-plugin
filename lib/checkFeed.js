    ...
    return new Promise(async(resolve, reject) => {
        ...
        .then(async(orphans) => {
            ...
            for(let orphan of orphans){
                console.log("Check", orphan.uri)
                if(orphan.repliedto==null){
                    const orphan_uri = orphan.inReplyTo;
                    console.log("Missing parent!", orphan.inReplyTo)
...
async function checkFeed(){
    ...
    console.log("Check feed for followers", follows)
    ...
    await checkOrphans()
    .then((d) => {
        console.log("Checked orphans")
    })
    .catch((e) => {
        console.error("ERROR checking orphans", e)
    })

    console.log("Checking addressees")
