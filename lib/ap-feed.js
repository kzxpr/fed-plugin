            ...
            .catch(error => {
                if(error.response){
                    if(error.response.status){
                        reject("Error from axios in /getObjectItem on "+url+". Returned: "+error.response.status)
                    }else{
                        reject("Error from axios in /getObjectItem on "+url+". Returned: "+error.response)
                    }
                }else{
                    reject("Error from axios in /getObjectItem on "+url+". Returned: "+error)
                }
            });
        }
    });
