...
async function addAnnounce(message_uri, account_uri, activity_uri){   
    console.log("addAnnounce", message_uri, account_uri)
    let newAnnounce = await Announce.query().insert({ message_uri, account_uri, createdAt: fn.now(), activity_uri })
