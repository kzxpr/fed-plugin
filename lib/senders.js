...
async function sendDelete(from_username, ap_key, to_uri, object_id){
    return new Promise(async(resolve, reject) => {
        const DOMAIN = this.getDomain();
...
async function sendAnnounce(from_username, ap_key, to_uri, object_id){
    return new Promise(async(resolve, reject) => {
        ...
        .then((d) => {
            console.log("SJOV fra sendAnnounce", d.data)
            resolve(d)
        })
        .catch((e) => {
            console.log("FEJL fra sendAnnounce", e)
            reject(e)
        })
    })
}
...
async function sendCreate(from_username, ap_key, obj, guid = ""){
    return new Promise(async(resolve, reject) => {
        ...
        console.log("Now in sendCreate", obj)
...
async function sendUpdate(from_username, ap_key, obj, params){
    return new Promise(async(resolve, reject) => {
        const DOMAIN = this.getDomain();

        const to_field = params.to;
        const cc_field = params.cc;
        const ref_url = params.id;
...
module.exports = { sendLike, sendAnnounce, sendNote, sendAccept, sendFollow, sendCreate, sendUpdate, sendDelete }