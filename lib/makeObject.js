...
async function makeObject(object, params, body){
    ...
    if(object=="Id"){
        ...
        obj = await makeNote(username, domain, manual_guid, { published, name, n_attachs, href, mediaType, tags, content, to, cc, sensitive, url, summary, inReplyTo, pub, followshare, updated })
